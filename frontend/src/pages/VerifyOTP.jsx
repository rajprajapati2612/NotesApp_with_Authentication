...
//         {}
//       <div className='flex-1 flex items-cent justify-center p-4 '>
...
//                                     <span className='text-sm text-shadow-muted-foreground'>Redirecting....</span>
//                                 </div>
...
//                                         {isLoading ? <>
//                                         <Loader2 className='mr-2 h-4 w-4 animate-spin'/>Verifying</>:"Verify code"}
//                                     </Button>
