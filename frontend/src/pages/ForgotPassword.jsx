                            ...
                            isSubmitted ? (
                                <div className='py-6 flex flex-col items-center justify-center text-center space-y-4'>
                                  ...
                                  <div className='space-y-2 '>
                                    ...
                                    <p>
                                        If youn't see yhe email, check your span folder or{""}
                                ...
                                <form className='space-y-4' onSubmit={handleForgotPassword}>
                                    ...
                                    <Button  onClick={handleForgotPassword} className="w-full gb-green-600 text-white relative hover:bg-green-500 cursor-pointer">
                                        {
                                          isLoading ?(
                                            <>
